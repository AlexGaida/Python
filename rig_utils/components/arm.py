...
import rig_utils.joint_utils
import rig_utils.name_utils
...
def build(joint_1, joint_2, joint_3, name="", prefix_name="", suffix_name=""):
    ...
    """
    # create joint
    bnd_joints = rig_utils.joint_utils.create_joints_from_array(
        (joint_1, joint_2, joint_3), get_names(name + "_" + rig_utils.name_utils.BND_JNT_SUFFIX_NAME))
    ik_joints = rig_utils.joint_utils.create_joints_from_array(
        (joint_1, joint_2, joint_3), get_names(name + "_" + rig_utils.name_utils.IK_JNT_SUFFIX_NAME))
    fk_joints = rig_utils.joint_utils.create_joints_from_array(
        (joint_1, joint_2, joint_3), get_names(name + "_" + rig_utils.name_utils.FK_JNT_SUFFIX_NAME))
